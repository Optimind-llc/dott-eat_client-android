...
public class DrawableBadge extends Drawable {
    ...
    public DrawableBadge(Context context) {
    ...
    public void draw(Canvas canvas) {
        ...
        // Position the badge in the top-right quadrant of the cartIcon.
